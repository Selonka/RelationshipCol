...
class RelationshipCountColumnChild extends MantisColumn {

	public $column = "RelationshipCountColumnChild";
	...
	public function cache( array $p_bugs ) {
		...
		while ( $t_row = db_fetch_array( $t_result ) ) {
				if ( !isset( $this->cache[ $t_row['bugid'] ] ) ) {
					$this->cache[ $t_row['bugid'] ] =  $t_row['countchild'];
			}
		}
