...
class RelationshipCountColumnParent extends MantisColumn {

	public $column = "RelationshipCountColumnParent";
	...
	public function cache( array $p_bugs ) {
		...
		while ( $t_row = db_fetch_array( $t_result ) ) {
				if ( !isset( $this->cache[ $t_row['bugid'] ] ) ) {
					$this->cache[ $t_row['bugid'] ] =  $t_row['countparent'];
			}
		}
	...
	public function sortquery( $p_dir ) {
		...
		return array(
			...
			'order' => "rcount.countParent $p_dir",
		);
	}
}
